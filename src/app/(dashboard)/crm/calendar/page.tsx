...
export default async function CRMCalendarPage() {
    ...
    return (
        <div className="flex flex-col h-full bg-zinc-100/50 dark:bg-black/20">
                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                        <Link href="/crm/pipeline" className="flex-1 sm:flex-none">
                            <button className="w-full flex items-center justify-center px-4 py-2.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 text-sm font-semibold rounded-lg hover:bg-zinc-50 transition-all">
            ...
            <div className="flex-1 p-6 overflow-hidden max-w-7xl mx-auto w-full">
