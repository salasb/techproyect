...
export default async function DashboardPage({ searchParams }: Props) {
    ...
    const periodLabels: Record<string, string> = {
        ...
        '12_months': 'Último año'
    };

    // The original Props interface is no longer needed if searchParams are handled differently or component becomes client-side.
    // interface Props {
    //     searchParams: Promise<{ [key: string]: string | string[] | undefined }>
    // }

    export default function DashboardPage() { // Changed to a client component, removed async and props
