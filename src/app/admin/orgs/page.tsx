...
export default async function AdminOrgsPage() {
    const traceId = "ORG-PAGE-V460";
    console.log(`[ADMIN_ORGS][${traceId}] Loading start v4.6.0`);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-2">
                <div>
                    <h1 className="text-3xl font-black italic tracking-tighter text-slate-900 dark:text-white uppercase">Directorio Maestro</h1>
                    <p className="text-slate-500 font-medium text-sm italic">Gobernanza de Ecosistemas v4.6.0</p>
                </div>
