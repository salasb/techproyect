...
export default async function AdminSettingsPage() {
    console.log("[ADMIN_SETTINGS] Loading start v4.1");
    ...
    try {
        ...
        console.error("[ADMIN_SETTINGS] Fetch failed:", normalized.code);
        ...
        <div className="space-y-10 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-2">
                <div>
                    ...
                    <p className="text-slate-500 font-medium text-sm italic">Parámetros globales y gobernanza del motor TechWise.</p>
                </div>
            </div>
            ...
            <div className="grid gap-10">
                ...
                <Card className="rounded-[3rem] border-border shadow-2xl overflow-hidden bg-card transition-all hover:shadow-blue-500/5">
                    <CardHeader className="bg-slate-50/50 dark:bg-zinc-900/50 border-b border-border p-10">
                        ...
                        <CardDescription className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mt-2 ml-10">
                            Configuración maestra de los nodos del ecosistema.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="p-10 space-y-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="grid gap-3">
                                <Label htmlFor="appName" className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Nombre Maestro de la Plataforma</Label>
                            ...
                            <div className="grid gap-3">
                                <Label htmlFor="supportEmail" className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Terminal de Soporte Técnico</Label>
                        ...
                        <div className="pt-8 border-t border-border flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="flex items-center gap-3 bg-amber-50 dark:bg-amber-900/20 px-4 py-2 rounded-xl border border-amber-100 dark:border-amber-800/50">
                                ...
                                <p className="text-[10px] text-amber-700 dark:text-amber-400 font-black uppercase tracking-widest">
                                    {isPreview ? 'Edición bloqueada: Entorno de Preview / Dev' : 'Requiere autorización de Nivel 3'}
                                </p>
                            </div>
                ...
                {/* Commercial Catalog Summary */}
                <Card className="rounded-[3rem] border-border shadow-xl overflow-hidden bg-card">
                    <CardHeader className="bg-slate-50/50 dark:bg-zinc-900/50 border-b border-border p-10">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                <CardTitle className="text-xs font-black uppercase tracking-[0.4em] text-slate-500">Oferta Comercial Activa</CardTitle>
                                <CardDescription className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mt-2">Planes disponibles para nuevos registros.</CardDescription>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            {plans.length === 0 && !errorState && (
                                <div className="p-20 text-center border-2 border-dashed border-border rounded-[2.5rem]">
                                    ...
                                    <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest italic opacity-60">No se detectan planes activos en el motor comercial</p>
                                </div>
                            )}
                        </div>
                    </CardContent>
